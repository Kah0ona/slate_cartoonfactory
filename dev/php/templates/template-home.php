	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<article class="content-article content-1-article-1 u-gridCol4">
				...
				<ul class="content-1-article-1-ul">
					<li>
						...
						<span><a href="#">karikaturen</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">sneltekenen</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">cartoons</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">animaties</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">strips</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">karakterontwerp</a></span>
					</li>
					<li>
						<svg class="Icon Icon--inline" viewBox="0 0  128 128">
							<img class="starcartoon"src="<?php echo get_stylesheet_directory_uri(); ?>/ico/bulletImg.png"/>
						</svg>
						<span><a href="#">workshops</a></span>
					</li> 

				</ul>
			</article>
			<article class="content-article content-1-article-2 u-gridCol8">
				<iframe class="content-1-article-2-video" src="//www.youtube.com/embed/JeSCoF5hy8c" frameborder="0" allowfullscreen></iframe>
			</article>
		</content> 
		...
		<content class="content-2 u-gridRow">
	 	...
	 	<content class="content-3 u-gridRow">
	 		<article class="content-article content-3-article-1 u-gridCol8">
	 			<a class="button1">karikaturen</a><p>
	 				The Cartoon Factory heeft een reputatie hoog te 
					houden op het gebied van karikaturen tekenen. 
		...
		<content class="content-4 u-gridRow">
			...
			<article class="content-article content-4-article-2 u-gridCol6">
				<a class="button1">Cartooning</a><p>Cartoons, strips, karakters en animaties zijn voor velerlei doeleinden inzetbaar. Deze kunnen voor een (glim)lach 
		...
		<content class="content-6 u-gridRow">
			<article class="content-article content-6-article-1 u-gridCol12">
				<a class="button1">tot slot!</a><p>Bent u op zoek naar een mogelijkheid om uw communicatie met humor aan te pakken, maar wel een 
